...
public class GAlgebraTest {
    ...
    public static Stream<Arguments> _testPow_dataSet_field_2_3() {
        ...
        SingleTermPolynomial x3 = pol(1, 1);
        SingleTermPolynomial x4 = pol(1, 1, 0);
        SingleTermPolynomial x5 = pol(1, 1, 1);
        SingleTermPolynomial x6 = pol(1, 0, 1);
        SingleTermPolynomial x7 = pol(0, 0, 1);

        return Stream.of(
                Arguments.of(gAlgebra, x, 1, new GPolynomial(gSpace, x)),
                Arguments.of(gAlgebra, x, 2, new GPolynomial(gSpace, eye(2))),
                Arguments.of(gAlgebra, x, 3, new GPolynomial(gSpace, x3)),
